        ...
        <div class="main-wrapper">
          ...
          <?php
            if(isset($_SESSION['u_id'])){
                  ...
                  if($_SESSION['u_type']=='admin'){
                    ...
                    echo '<form action="#" method="POST" class="deleteForm" >
                          ...
                          <p> <i style="position:absolute; top:190px;left:180px;  border: solid black;border-width: 0 3px 3px 0;display: inline-block;padding: 3px;transform: rotate(135deg); -webkit-transform: rotate(135deg);"></i></p>
                          </form>';
            ...
            <div class="main-wrapper" style="position:absolute; top:40%;left:14%; ">
                  ...
                  <form class="signup-form" style="margin-left:30%; " action="includes/changeProduct.inc.php" method="POST" >
                    <input type="text" name="id" placeholder="ID" >
                    <input type="text" name="title" placeholder="Title" >
                    <input type="text" name="price" placeholder="Price">
                    <input type="text" name="pricer" placeholder="Reduced price">
            ...
            <?php  $fullUrl= "http://localhost/loginsystem/changeProduct.php $_SERVER[REQUEST_URI]";
            ...
            {
            echo '<div  style="background-color:rgb(179, 179, 179);position:fixed; top:54%;left:37%; width:360px; height:100px;"></div>
              <p class="deleteText" style="color:rgb(153, 0, 0);position:fixed; top:57%; left:41%;">Please enter the id !</p>
              <form action="includes/pressed.inc.php" method="POST"  >
              <button  type="submit" name="submit"  style="width:200px;position:fixed; top:65%; left:46%; width:100px;" >OK</button>
              </form>';
            }
            ...
            {
            echo '<div  style="background-color:rgb(179, 179, 179);position:fixed; top:54%;left:37%; width:360px; height:100px;"></div>
              <p class="deleteText" style="color:rgb(153, 0, 0);position:fixed; top:57%; left:42.5%;">Invalid id entered !</p>
              <form action="includes/pressed.inc.php" method="POST"  >
              <button  type="submit" name="submit"  style="width:200px;position:fixed; top:65%; left:46%; width:100px;" >OK</button>
              </form>';
            }
            ...
            {
            echo '<div  style="background-color:rgb(179, 179, 179);position:fixed; top:54%;left:37%; width:360px; height:100px;"></div>
              <p class="deleteText" style="color:green;position:fixed; top:57%; left:42.5%;">Successfully changed !</p>
              <form action="includes/pressed.inc.php" method="POST"  >
              <button  type="submit" name="submit"  style="width:200px;position:fixed; top:65%; left:46%; width:100px;" >OK</button>
              </form>';
            }
